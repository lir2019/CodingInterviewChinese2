...
ListNode* ExampleFindKthToTail(ListNode* pListHead, unsigned int k)
{
...
ListNode* LrFindKthToTail(ListNode* pListHead, unsigned int k) {
...
{
  return LrFindKthToTail(pListHead, k);
}
